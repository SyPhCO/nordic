 ...
 */
final class Version20240119090234 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE team ADD gallery5 VARCHAR(255) DEFAULT NULL, ADD gallery6 VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE team DROP gallery5, DROP gallery6');
    }
}
